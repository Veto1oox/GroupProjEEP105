...
co2_pk = (df_glb_emi.loc[df_glb_emi["country"].eq(COUNTRY), ["year", CO2_COL]].dropna().astype({"year": int}).query("@START <= year <= @END").sort_values("year"))
